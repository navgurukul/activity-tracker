...
export const API_PATHS = {
  ...
  TIMESHEET_ADMIN_CREATE: "/v1/timesheets/admin/create",
  ...
  LEAVES_BALANCES_EMPLOYEE: "/v1/leaves/balances/employee",
  ...
  LEAVES_ADMIN_REQUEST_UPDATE: "/v1/leaves/admin/requests/{id}",
  LEAVES_ADMIN_REQUEST_DELETE: "/v1/leaves/admin/requests/{id}",
  LEAVES_ADMIN_BALANCES_UPDATE: "/v1/leaves/admin/balances/allocated",
...
export const TRACKER_BACKFILL_VALIDATION_MESSAGE =
